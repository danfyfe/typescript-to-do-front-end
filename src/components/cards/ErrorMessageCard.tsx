...
const ErrorMessageCard: React.FC<{ errorMessage: string | null, setErrorMessage: Function, setAdding: Function }> = props => {

  const { errorMessage, setErrorMessage, setAdding } = props
